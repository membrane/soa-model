...
class SimpleContentDiffGeneratorTest extends GroovyTestCase{
  ...
  void testRestrictionDiff(){
    ...
    assert diffs.diffs.description.toString().contains('Enumeration with value: red removed.')
    assert diffs.diffs.description.toString().contains('Enumeration with value: blue added.')
