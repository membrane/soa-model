...
:homeOk
set "CLASSPATH=%CLASSPATH%;%SOA_MODEL_HOME%/lib/soa-model-core-1.2.2.jar"
...
java  -classpath "%CLASSPATH%" org.membrane_soa.soa_model.analyzer.WSDLAnalyzer %1 %2 %3 %4 %5 %6
