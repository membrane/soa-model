...
Windows Exsample:
cd c:\soa-model-home
c:\soa-model-home>bin\wsdldiff samples\diff\original\article.wsdl samples\diff\modified\article.wsdl


Linux/Mac Exsample:
cd soa-model-home
bin/wsdldiff.sh samples/diff/original/article.wsdl samples/diff/modified/article.wsdl
...
Windows Exsample:
c:\soa-model-home>bin\schemadiff samples\diff\original\common.xsd samples\diff\modified\common.xsd


Linux/Mac Exsample:
bin/schemadiff.sh samples/diff/original/common.xsd samples/diff/modified/common.xsd
