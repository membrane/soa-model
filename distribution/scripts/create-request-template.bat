...
if exist "%SOA_MODEL_HOME%\bin\create-request-template.bat" goto homeOk
...
:homeOk
java  -classpath "%SOA_MODEL_HOME%/lib/*" org.membrane_soa.soa_model.creator.CreateSOAPRequestTemplate %1 %2 %3 %4 %5 %6
